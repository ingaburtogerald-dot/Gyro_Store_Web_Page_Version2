  ...
  return (
    <div
      className={cn(
        ...
        "ease-expo group relative flex w-full items-stretch overflow-hidden rounded-lg border bg-surface/60 backdrop-blur-xl transition duration-300",
        focused
    ...
    >
      ...
      {value && (
        <button
          ...
          className="my-auto mr-1 grid h-8 w-8 shrink-0 place-items-center rounded-md text-muted transition-colors hover:bg-surface-2 hover:text-text"
        >
          <X className="h-4 w-4" />
        </button>
      )}
      ...
      <button
        ...
        className="my-1.5 mr-1.5 flex aspect-square shrink-0 items-center justify-center rounded-md bg-accent text-bg transition-all duration-300 hover:bg-accent-hover active:scale-95"
      >
        <Search className="h-[18px] w-[18px]" />
      </button>
    </div>
