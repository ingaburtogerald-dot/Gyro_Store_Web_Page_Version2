                    ...
                    >
                      ...
                      <div className="mb-6 flex flex-col gap-4 sm:flex-row items-stretch">
                        ...
                        <a href={whatsappUrl} target="_blank" rel="noreferrer" className="flex-1 flex">
                          <Button
                            variant="whatsapp"
                            className="ease-expo w-full min-h-[3.5rem] h-full py-3.5 px-4 rounded-2xl text-base transition duration-300 hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-3"
                          >
                            ...
                            <span className="text-left leading-tight">Compras al por mayor<br className="hidden lg:inline" /> consulta por WhatsApp</span>
                          </Button>
                        </a>
                      </div>
