...
import { Receipt, Mail, MessageSquare, Search, Calendar, Check, ChevronDown, ChevronUp, AlertCircle } from "lucide-react";
        ...
        <div className="flex w-full min-w-0 items-center justify-between sm:w-auto sm:flex-1 sm:justify-start sm:gap-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="truncate text-sm font-bold text-text">{p.sellerName}</span>
