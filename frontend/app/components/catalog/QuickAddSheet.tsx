...
//
// Va en un portal a <body>: la card anima transform (framer-motion) y un ancestro
// transformado rompería el position:fixed del sheet. El portal escapa del scope
// [data-skin="store"], así que el wrapper lo re-declara para conservar los tokens.
